...
const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    link: "https://productive.co.il",
    image: Productive,
    technologies: ["Salesforce", "Monday", "SQL", "Make", "Zapier", "Postman", "Jira"],
  },
  {
    ...
    technologies: ["React", "TypeScript", "Context", "Material-UI", "Auth0", "SWR", "PWA"],
  },
  {
    header: "Full-Stack Developer",
    subHeader: "Socialo",
  ...
  },
  {
    ...
    type: "work",
    image: eBigay,
    technologies: ["React", "TypeScript", "Context", "React-Query", "Styled-Components", "MUI"],
  },
  {
